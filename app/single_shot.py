...
class CliArgs:
    ...
    # RGB 文件路径
    COLOR_IMG: str = "/app/fpinterface-client/src/fpinterface_client/assets/color.png"
    # 掩膜图片路径
    MASK_IMG: str = "/app/fpinterface-client/src/fpinterface_client/assets/workspace_mask.png"
    # 深度图片路径
    DEPTH_IMG: str = "/app/fpinterface-client/src/fpinterface_client/assets/depth.png"
    # 相机内参矩阵文件
